...
// Test prop change
const iotcId2 = 'a56yutiodse';
const iotcProperties2 = ['temp', 'pressure'];
const propertyPositions2 = {};
iotcProperties2.forEach((prop) => {
    const position = () => {
        switch (prop) {
            case 'temp':
    ...
    propertyPositions2[prop] = position();
});
...
export const Mock = (args, { globals: { theme } }) => {
    ...
    setTimeout(() => {
        setProperties({
            properties: iotcProperties2,
            additionalProperties: propertyPositions2,
            id: iotcId2
        });
    }, 5000);
