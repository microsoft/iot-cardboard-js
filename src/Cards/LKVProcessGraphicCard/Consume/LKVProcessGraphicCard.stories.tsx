...
const dtId = 'CarTwin';
const dtProperties = ['OutdoorTemperature', 'Speed', 'OilPressure'];

const iotcPropertyPositions = {};
iotcProperties.forEach((prop) => {
    ...
    iotcPropertyPositions[prop] = position();
});

const dtPropertyPositions = {};
dtProperties.forEach((prop) => {
    const position = () => {
        switch (prop) {
            case 'OutdoorTemperature':
                return { left: '80%', top: '5%' };
            case 'Speed':
                return { left: '80%', top: '40%' };
            case 'OilPressure':
                return { left: '30%', top: '70%' };
    ...
    dtPropertyPositions[prop] = position();
});
    ...
    return (
        <div style={chartCardStyle}>
            <LKVProcessGraphicCard
                ...
                additionalProperties={iotcPropertyPositions}
    ...
    return (
        <div style={chartCardStyle}>
            <LKVProcessGraphicCard
                ...
                additionalProperties={dtPropertyPositions}
