...
// for ErrorBoundaryCompositeCard story
const BuggyCounter: React.FC<Record<string, unknown>> = () => {
...
// for ErrorBoundaryCompositeCard story
const BuggyCounterWithErrorHandling: React.FC<Record<string, unknown>> = () => {
    const [counter, setCounter] = useState(0);
    ...
    useEffect(() => {
        if (counter === 5) {
            // Simulate a JS error
            throw new Error('I also crashed!');
        }
    }, [counter]);
