...
export const SET_SCENE_DESCRIPTION = 'SET_SCENE_DESCRIPTION';
export const SET_LATITUDE_VALUE = 'SET_LATITUDE_VALUE';
export const SET_LONGITUDE_VALUE = 'SET_LONGITUDE_VALUE';
export const SET_IS_SHOW_ON_GLOBE_ENABLED = 'SET_IS_SHOW_ON_GLOBE_ENABLED';
export const SET_SCENE_BLOB_URL = 'SET_SCENE_BLOB_URL';
...
export const RESET_OVERWRITE_FILE_AND_EXIST_IN_BLOB =
