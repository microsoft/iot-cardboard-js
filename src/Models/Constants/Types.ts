 ...
 * @param isAdditionalSearchParamsRequired if additional search parameters are required they are enforced to be checked to make getResources call
 */
export type AzureResourceSearchParams = {
    ...
    isAdditionalSearchParamsRequired?: boolean;
};
